...
CREATE TABLE [TB_Flix] ([DATA] VARCHAR(10),[ESTADOS] VARCHAR(20),[UF] VARCHAR(10),[TOTAL_USUARIOS] SMALLINT,[PERIODO_DE_ACESSOS] VARCHAR(10),[SEGMENTOS] VARCHAR(20),[TIPO_DE_CONTA] VARCHAR(20),[VALOR] VARCHAR(10));


-- Inserindo Tabela de Dados 
INSERT INTO [TB_Flix] ([DATA],[ESTADOS],[UF],[TOTAL_USUARIOS],[PERIODO_DE_ACESSOS],[SEGMENTOS],[TIPO_DE_CONTA],[VALOR]) VALUES 
